  ...
  <div class="container">
    <div class="navbar-translate">
      <a class="navbar-brand" rel="tooltip" title="Modern Web Applications Created by G.M.E" data-placement="bottom" target="_blank">
        <img src="../img/CodeBlockLogoWhite.png" alt="CodeBlock White Logo" style="width:30px;height:30px;"> <span class="white">CodeBlock</span> <div class="header-name white">Web Applications</div>
      </a>
