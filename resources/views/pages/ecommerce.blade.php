  ...
  <div class="wrapper">
    <div class="header header-1">
      <div class="page-header header-filter">
        <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/shop.jpeg');"></div>
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-md-7 mr-auto text-left">
              <h1 class="title">See our latest collection!</h1>
              <br />
              <div class="buttons">
                <a href="#pablo" class="btn btn-success btn-round btn-lg mr-3 pulse">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card card-product card-plain">
                    ...
                    <div class="card-body">
                      ...
                      <div class="card-footer">
                        <div class="price-container">
                          <span class="price-old"> &euro; 1179</span>
                          <span class="price-new ml-1"> &euro; 999</span>
                        </div>
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-md-10 mx-auto text-center mt-5">
            <h3 class="section-title">Simplicity is the ultimate sophistication</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="card card-blog card-background" data-animation="true">
              <div class="full-background" style="background-image: url('../assets/img/leather-shoes.jpeg')"></div>
              <div class="card-body">
                <div class="content-bottom">
                  <h6 class="card-category">Footwear</h6>
                  <a href="#pablo">
                    <h3 class="card-title">Leather Shoes</h3>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="card card-blog card-background" data-animation="true">
              <div class="full-background" style="background-image: url('../assets/img/tshirts.jpeg')"></div>
              <div class="card-body">
                <div class="content-bottom">
                  <h6 class="card-category">T-shirts</h6>
                  <a href="#pablo">
                    <h3 class="card-title">100% Silk T-shirts</h3>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-blog card-background" data-animation="true">
              <div class="full-background" style="background-image: url('../assets/img/accesories.jpeg')"></div>
              <div class="card-body">
                <div class="content-bottom">
                  <h6 class="card-category">Accessories</h6>
                  <a href="#pablo">
                    <h3 class="card-title">Bracelets and Watches</h3>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-8">
            <div class="card card-blog card-background" data-animation="true">
              <div class="full-background" style="background-image: url('../assets/img/winter.jpeg')"></div>
              <div class="card-body">
                <div class="content-bottom">
                  <h6 class="card-category">Winter</h6>
                  <a href="#pablo">
                    <h3 class="card-title">Latest FW Collection</h3>
                  </a>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card card-product">
                    <div class="card-image">
                      <a href="#">
                        <img src="../assets/img/shorts.png" alt="..." />
                      </a>
                    </div>
                    <div class="card-body">
                      <a href="#">
                      ...
                      <div class="card-footer">
                        <div class="price-container">
                          <span class="price-old"> &euro; 879</span>
                          <span class="price-new ml-1"> &euro; 499</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card card-product">
                    <div class="card-image">
                      <a href="#">
                        <img src="../assets/img/bracelet.png" alt="..." />
                      </a>
                    </div>
                    <div class="card-body">
                      <a href="#">
                        <h4 class="card-title">Diamond Bracelet</h4>
                      </a>
                      <div class="card-footer">
                        <div class="price-container">
                          <span class="price">&euro; 19,999</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-md-5 mr-auto">
                      ...
                      <h3 class="card-title"> Lisa Michael </h3>
                    ...
                    <div class="col-md-6 ml-auto">
                      <img class="d-block" src="../assets/img/lucy.jpg" alt="Second slide">
                    </div>
                  </div>
                </div>
              </div>
              <div class="carousel-item">
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-md-6 ml-auto">
                      <img class="d-block" src="../assets/img/tom-klein.jpg" alt="First slide">
                    </div>
                  </div>
                </div>
              </div>
