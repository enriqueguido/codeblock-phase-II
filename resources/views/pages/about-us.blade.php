...
<body class="about-us">
  ...
  <div class="wrapper">
    <div class="page-header">
      <img src="../assets/img/path3.png" class="path path3">
      <svg class="hidden">
        <!-- All deco shapes -->
        <defs>
    ...
    <div class="section about-description">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            <img class="d-block" src="../assets/img/matthew-henry.jpg" alt="First slide">
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="carousel-item active">
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <img class="d-block" src="../assets/img/charlie.jpg" alt="First slide">
                      </div>
                      <div class="col-md-4">
                        <div class="wrapper">
                          <div class="category">
                ...
                <div class="carousel-item">
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <img class="d-block" src="../assets/img/lucy.jpg" alt="First slide">
                      </div>
                      <div class="col-md-4">
                        <div class="wrapper">
                          <div class="category">
