          ...
          <div class="card card-login">
            <form class="form" method="" action="">
              <div class="card-header">
                <img class="card-img" src="../assets/img/shape.png" alt="Card image">
                <h4 class="card-title">Reset Password</h4>
              </div>
              <div class="card-body">
                <h4 class="description text-center">Enter email address to reset password</h4>
                ...
                <a href="#pablo" class="btn btn-warning btn-round btn-lg btn-block">Request Reset</a>
              </div>
              <div class="card-footer">
                <div class="pull-left ml-3 mb-3">
                  <h6>
                    <a href="#pablo" class="link footer-link">Back to Sign in</a>
                  </h6>
                </div>
