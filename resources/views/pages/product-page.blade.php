...
<body class="product-page">
  ...
  <div class="wrapper">
    <div class="page-header page-header-small">
      <img src="../assets/img/shape-s.png" class="path shape">
      <div class="container">
        <h1 class="h1-seo">Our products</h1>
      ...
      <div class="container">
        <div class="row">
            ...
            <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block" src="../assets/img/shirt.png" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block" src="../assets/img/shorts.png" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block" src="../assets/img/tshirt.png" alt="Third slide">
                </div>
              </div>
          ...
          <div class="col-lg-6 col-md-12 mx-auto">
            ...
            <p class="description">Eres' daring 'Grigri Fortune' swimsuit has the fit and coverage of a bikini in a one-piece silhouette. This fuchsia style is crafted from the label's sculpting peau douce fabric and has flattering cutouts through the torso and back. Wear yours with mirrored sunglasses on vacation.</p>
            <br>
              ...
              <div class="col-lg-4 col-md-4">
                ...
                <div class="input-group">
                  <div class="input-group-btn">
                    <button id="down" class="btn btn-warning btn-round btn-simple" onclick=" down('0')"><i class="tim-icons icon-simple-delete"></i></button>
                  </div>
                  <input type="text" id="myNumber" class="form-control input-number" value="1" />
                  <div class="input-group-btn">
                    <button id="up" class="btn btn-warning btn-round btn-simple" onclick="up('100')"><i class="tim-icons icon-simple-add"></i></button>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-6">
                <label>Select color</label>
                <select class="selectpicker" data-style="btn btn-warning btn-simple" data-size="7">
            ...
            <div class="row justify-content-start">
              <button class="btn btn-warning ml-3">Add to Cart &nbsp;<i class="tim-icons icon-cart"></i></button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="card card-product">
              <div class="card-image">
                <a href="#pablo">
                  <img class="img rounded" src="../assets/img/bag.png" />
                </a>
              </div>
              <div class="card-body">
                <h6 class="category text-warning">Trending</h6>
                <h4 class="card-title">
                  <a href="javascript:;" class="card-link text-white">Dolce & Gabbana</a>
                </h4>
                ...
                <div class="card-footer">
                  ...
                  <button class="btn btn-simple btn-warning btn-icon btn-round pull-right" rel="tooltip" title="" data-placement="left" data-original-title="Add to wishlist">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card card-product">
              <div class="card-image">
                <a href="#pablo">
                  <img class="img rounded" src="../assets/img/tshirt.png" />
                </a>
              </div>
              <div class="card-body">
                <h6 class="category text-warning">Popular</h6>
                <h4 class="card-title">
                  <a href="javascript:;" class="card-link text-white">Balmain</a>
                </h4>
                <div class="card-description">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card card-product">
              <div class="card-image">
                <a href="#pablo">
                  <img class="img rounded" src="../assets/img/shirt.png" />
                </a>
              </div>
              <div class="card-body">
                <h6 class="category text-warning">Popular</h6>
                <h4 class="card-title">
                  <a href="javascript:;" class="card-link text-white">Balenciaga</a>
                </h4>
                <div class="card-description">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card card-product">
              <div class="card-image">
                <a href="#pablo">
                  <img class="img rounded" src="../assets/img/jeans.png" />
                </a>
              </div>
              <div class="card-body">
                <h6 class="category text-warning">Trending</h6>
