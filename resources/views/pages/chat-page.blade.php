            ...
            <div class="card card-plain">
              ...
              <div class="list-group list-group-chat list-group-flush">
                <a href="javascript:;" class="list-group-item active">
                  <div class="media">
                    <img alt="Image" src="../assets/img/p10.jpg" class="avatar">
                ...
                <a href="javascript:;" class="list-group-item">
                  <div class="media">
                    <img alt="Image" src="../assets/img/johana.jpg" class="avatar">
                    <div class="media-body ml-2">
                      <div class="justify-content-between align-items-center">
                ...
                <a href="javascript:;" class="list-group-item">
                  <div class="media">
                    <img alt="Image" src="../assets/img/ryan.png" class="avatar">
                    <div class="media-body ml-2">
                      <div class="justify-content-between align-items-center">
                ...
                <a href="javascript:;" class="list-group-item">
                  <div class="media">
                    <img alt="Image" src="../assets/img/kareya-saleh.jpg" class="avatar">
                    <div class="media-body ml-2">
                      <div class="justify-content-between align-items-center">
                      ...
                      <span class="text-muted text-small col-11 p-0 text-truncate d-block">It’s an effective resource regardless..</span>
                    </div>
                  </div>
                </a>
                <a href="javascript:;" class="list-group-item">
                  <div class="media">
                    <img alt="Image" src="../assets/img/christian.jpg" class="avatar">
                    <div class="media-body ml-2">
                      <div class="justify-content-between align-items-center">
                    ...
                    <div class="card ">
                      <div class="card-body p-2">
                        <div class="col-12 p-0">
                          <img src="../assets/img/luke.jpg" alt="Rounded image" class="img-fluid rounded mb-1">
                        </div>
                        <div>
