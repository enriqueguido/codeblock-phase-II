              ...
              <div class="card-body">
                <div class="media align-items-center mb-3">
                  <div class="col-md-5 col-6">
                    <img src="../assets/img/gucci.png" alt="Rounded image" class="img-fluid rounded shadow">
                  </div>
                ...
                <div class="media align-items-center">
                  <div class="col-md-5 col-6">
                    <img src="../assets/img/jacket.png" alt="Rounded image" class="img-fluid rounded shadow">
                  </div>
                  <div class="media-body">
                ...
                <form class="code-validate">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="name" placeholder="Discount Code" aria-label="Discount">
              ...
              <div class="container">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="firstName" placeholder="Cristopher" aria-label="Cristopher" required="">
                  </div>
                  <div class="col-md-6">
                    <label class="labels">
                      Last name
                    ...
                    <input type="text" class="form-control" name="lastName" placeholder="Thompson" aria-label="Thompson" required="">
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col-md-6">
                    <div class="js-form-message mb-6">
                      ...
                      <input type="email" class="form-control" name="emailAddress" placeholder="thompson@gmail.com" aria-label="thompson@gmail.com" required="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="js-form-message mb-6">
                      ...
                      <input type="text" class="form-control" placeholder="+4 (0762) 230991" aria-label="+4 (0762) 230991">
                    </div>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col-md-8">
                    <div class="js-form-message mb-6">
                      ...
                      <input type="text" class="form-control" name="streetAddress" placeholder="420 Long Beach, CA" aria-label="420 Long Beach, CA" required="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="js-form-message mb-6">
                ...
                <div class="nav nav-tabs nav-tabs-primary btn-group" role="tablist">
                  <a class="btn btn-sm btn-info btn-simple active" data-toggle="tab" href="#link1" role="tablist">
                    Credit Card
                  </a>
                  <a class="btn btn-sm btn-info btn-simple" data-toggle="tab" href="#link2" role="tablist">
                    PayPal
                  </a>
                </div>
                <div class="tab-content tab-space">
                  <div id="link1" class="tab-pane active">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <a href="javascript:;">
                        <span class="fas fa-angle-left mr-2"></span> Return to cart</a>
