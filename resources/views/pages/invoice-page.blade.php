      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 ml-auto mr-auto">
            <div class="card card-invoice">
              <div class="card-header text-center" data-color-icon="warning">
                <div class="row justify-content-between">
                  <div class="col-md-4 text-left">
                    <img class="mb-2" src="../assets/img/creative-tim-white-slim2.png" alt="Logo">
                    <h4>
                ...
                <div class="row justify-content-md-between">
                  <div class="col-md-4 mt-5">
                    <h2 class="mt-3 text-left">Invoice no
                      <br>
              ...
              <div class="card-footer text-right">
                <div class="col-md-5">
                  <h4>Thank you!</h4>
                  <p class="description">If you encounter any issues related to the invoice you can contact us at:</p>
                  <h5 class="d-block">
                    email:
          ...
          <div class="col-md-3 ml-auto">
            <button type="button" class="btn btn-primary btn-print mt-5" onclick="window.print();return false;">
